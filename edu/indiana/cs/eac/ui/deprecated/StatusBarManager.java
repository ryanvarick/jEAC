...
public class StatusBarManager extends JPanel
{
	...
	public void setStatus(int status)
	{
		...
		{
			string += "Connected";
			image = JEAC_Reference.getImage("status_connected.gif");
		}
		else if(status == DISCONNECTED)
		{
			string += "Disconnected";
			deviceLabel.setText("");
			image = JEAC_Reference.getImage("status_disconnected.gif");
		}
		...
		else if(status == CONNECTING)
		{
			...
			image = JEAC_Reference.getImage("status_warning.gif");
		}
