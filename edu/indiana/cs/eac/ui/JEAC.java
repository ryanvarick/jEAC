...
public class JEAC extends JFrame 
{
	...
	private static final String BUILD   = "265";
...
//		jeacMenu.add(runMenu);
	...
	/**
	 * HACK - Returns the simulation menu.
	 * 
	 * This is eventually going to hold simulations.
	 * 
	 * @author   Ryan R. Varick
	 * @since    1.2.0
	 * 
	 */
	private JMenu populateRunMenu()
	{
		JMenu runMenu = new JMenu("Run evolver");
		runMenu.setMnemonic('R');
		
		JMenuItem snakeMenuItem = new JMenuItem("SnakeEvolver");
		snakeMenuItem.addActionListener(new EvolverListener());
//		snakeMenuItem.setIcon(new BlankIcon(16, 16));
		
		runMenu.add(snakeMenuItem);
	...
	/**
	 * Listens for evolver stuff.  HACK
	 * 
	 */
	private class EvolverListener implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
...
//			c.setVisible(true);
			...
			if(evolverMenuItem.isSelected())
			{
				evolverFrame = new Console(new String[0]);
				evolverFrame.setVisible(true);
//				startInterfaceUpdateThread();
			}
